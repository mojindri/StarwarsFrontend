...
{ 
    ...
    public class Repository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        /// </summary>
        public Repository()
            : this(new DefaultDataService(new HttpClient()), Api)
        {
        ...
        public async Task<T> GetById(int id)
        {
            ...
            string jsonResponse = await this.dataService.GetDataResult(url);
        ...
        public async Task<ICollection<T>> GetEntities(int page = DefaultPage, int size = DefaultSize)
        {
            ...
            {
                jsonResponse = await this.dataService.GetDataResult(helper.Next);
                if (jsonResponse == null)
                {
                    return null;
                }
